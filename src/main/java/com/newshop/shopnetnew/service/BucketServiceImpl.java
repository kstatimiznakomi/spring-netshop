...
public class BucketServiceImpl implements BucketService {
    ...
    public BucketServiceImpl(BucketRepository bucketRepository, ProductRepository productRepository, @Lazy UserService userService,@Lazy BucketService bucketService){
